...
public class DirectoryControllerTest {
    ...
    void directoryCreation_shouldReturnDirectoryInfoWithCreated() throws Exception {
        var dirInfo = new ResourceInfoResponseDto("", DIRECTORY_PATH, null, ResourceType.DIRECTORY);
    ...
    void getDirectoryInfo_shouldReturnInfoWithOk() throws Exception{
        var resource1 = new ResourceInfoResponseDto("folder1/", "text.txt", 10L, ResourceType.FILE);
        var resource2 = new ResourceInfoResponseDto("folder1/", "folder2/", null, ResourceType.DIRECTORY);
